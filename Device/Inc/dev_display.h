...
#define MOUDLE_CHANNEL_NUM   2
#define MOUDLE_SCAN_LINE_NUM 1
...
#define CHANNEL_NUM          (MODULE_PER_COL * MOUDLE_CHANNEL_NUM)
#define CHANNEL_PIXEL_NUM    (MODULE_PIXEL_ROW * MODULE_PIXEL_COL * MODULE_PER_ROW / MOUDLE_CHANNEL_NUM)
#define SCAN_LINE_PIXEL_NUM  (CHANNEL_PIXEL_NUM / MOUDLE_SCAN_LINE_NUM)
