...
/* 板级默认网络配置: 192.168.0.232/24, 网关 192.168.1.1 */
// static const uint8_t g_default_ip[4]   = {192, 168, 0, 1};
static const uint8_t g_default_ip[4]   = {192, 168, 0, 232};
static const uint8_t g_default_mask[4] = {255, 255, 255, 0};
// static const uint8_t g_default_gw[4]   = {192, 168, 1, 1};
static const uint8_t g_default_gw[4] = {192, 168, 0, 1};
