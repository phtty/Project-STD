...
static const uint8_t s_default_ip[4] = {192, 168, 1, 100};
// static const uint8_t s_default_ip[4]   = {192, 168, 2, 100};
static const uint8_t s_default_mask[4] = {255, 255, 255, 0};
static const uint8_t s_default_gw[4]   = {192, 168, 1, 1};
// static const uint8_t s_default_gw[4] = {192, 168, 2, 1};

/* DP83848 PHY 设备对象与 IO 上下文 */
static dev_dp83848_obj_t s_dp83848_dev;
static dev_dp83848_io_ctx_t s_dp83848_io_ctx = {
    pl_eth_phy_io_init,
...
{
    int32_t state = dev_dp83848_link_state_get(&s_dp83848_dev);
...
void dev_eth_init(void)
{
    ...
    dev_dp83848_register_bus_io(&s_dp83848_dev, &s_dp83848_io_ctx);
    if (dev_dp83848_init(&s_dp83848_dev) != DP83848_STATUS_OK)
        Error_Handler();

    /* 注册 PHY 链路状态查询回调，供 Platform 层 _eth_low_level_init / pl_eth_link_task 使用 */
...
{
    pl_net_init(s_default_ip, s_default_mask, s_default_gw);
}
