 ...
 * @retval 0 缓冲区非空
 */
__always_inline uint8_t BSP_RB_IsEmpty(RingBuff_t *fifo)
{
 ...
 * @retval 0 缓冲区未满
 */
__always_inline uint8_t BSP_RB_IsFull(RingBuff_t *fifo)
{
 ...
 * @return 当前可读取的字节数
 */
__always_inline uint16_t BSP_RB_GetAvailable(RingBuff_t *fifo)
{
