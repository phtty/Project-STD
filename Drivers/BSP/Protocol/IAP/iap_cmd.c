...
static void cmd_ReportFirmwareStatus_03(ch_meta_t *meta, iap_frame_t *IAP_Data)
{
    ...
    ReData[0]           = config_info.app_info.size;                                        // �̼���С
    ReData[1]           = config_info.app_info.crc32;                                       // �̼�CRC32
    memcpy(ReData + 2, config_info.app_info.version, sizeof(config_info.app_info.version)); // �̼��汾��Ϣ
