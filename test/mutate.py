...
MUTANTS = [
 ...
 (TARGET,  "C6  播种 update_sta=FAILED","info.update_sta = APP_FLASH_IAP_UPDATED;\n        memset", "info.update_sta = APP_FLASH_IAP_FAILED;\n        memset"),
 (TARGET,  "C7  播种不设 magic",        "info.magic      = APP_FLASH_IAP_MAGIC;\n        info.update_sta = APP_FLASH_IAP_UPDATED;", "info.update_sta = APP_FLASH_IAP_UPDATED;"),
