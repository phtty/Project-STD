...
/* TIM3 init function —— 扫描节拍（自原 TIM2 搬来，参数与实机调优结论原样保留） */
...
/* TIM4 init function —— OE 亮度 PWM（自原 TIM3 搬来） */
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *tim_baseHandle)
{
    ...
    if (tim_baseHandle->Instance == TIM3) {
        ...
        /* TIM4 interrupt Init —— 优先级取 5，与已验证的 3833024 一致
           （原 TIM2 是 6，搬迁时按角色统一，不按定时器身份搬运） */
