...
/* ---- 向量表偏移 ----
 * 必须与 boards/5005048/board.ld 的 FLASH_ORIGIN 保持一致：5005048 直烧 0x08000000，
...
/* ---- 显示子系统的定时器角色 ----
 * 5005048：TIM2 出行同步中断（行扫描节拍），TIM3 出 8 级亮度 PWM。
 * 注意与 3833024 不同（那边是 TIM3/TIM4）——5005048 的 CubeMX 配置里没有 TIM4。
